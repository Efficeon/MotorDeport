...
public class RefrigeratorLorry extends Lorry implements Serializable{
    //static final long serialVersionUID = 5037585225066001448L;

    public RefrigeratorLorry(String licensePlate,
    ...
    public String toString(){
        ...
        return  "Грузовой автомобиль(Рефрижераторный кузов): " +
